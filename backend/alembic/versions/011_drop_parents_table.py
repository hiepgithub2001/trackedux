...
def downgrade() -> None:
    ...
    op.create_unique_constraint(op.f('uq_attendance_session_student_date'), 'attendance_records', ['class_session_id', 'student_id', 'session_date'], postgresql_nulls_not_distinct=False)
