...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "attendance_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("attendance_records.id"), nullable=True
        ),
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("student_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("students.id"), nullable=False),
        sa.Column(
            "class_session_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("class_sessions.id"), nullable=False
        ),
