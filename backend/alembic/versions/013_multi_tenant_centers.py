...
def upgrade() -> None:
    ...
    for table in TENANT_TABLES:
        ...
        op.execute(sa.text(f"UPDATE {table} SET center_id = :cid").bindparams(cid=LEGACY_CENTER_ID))
        # Make NOT NULL
    ...
    op.execute(sa.text("UPDATE users SET center_id = :cid").bindparams(cid=LEGACY_CENTER_ID))
